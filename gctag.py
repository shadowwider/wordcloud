...
def main():
    ...
    parser.add_argument('--model', metavar='INPUT_IMAGE_MODEL', default='./s.png', help='input the input_image_model')
    ...
    wordcloud = WordCloud(font_path=typeface, mask=image_mask, max_font_size=max_font_size,
                          background_color=background_color, margin=15, width=1080, height=960,max_words=2000,colormap='brg',
						  min_font_size = 10)
    try:
